# Generated by Django 2.2.10 on 2020-03-28 18:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verified_hash', models.CharField(blank=True, max_length=30, null=True)),
                ('verified_unique_id', models.CharField(blank=True, max_length=30, null=True)),
                ('chain_index', models.IntegerField(blank=True, null=True)),
                ('verified_datetime', models.CharField(blank=True, max_length=30, null=True)),
