...
urlpatterns = [
    ...
    path('events/<username>', views.verifier_detail_view, name='verifier_detail'),
    ...
    path('requests/<username>', views.requester_detail_view, name='requester_detail'),
    ...
    path('review/<username>', views.requester_detail_view, name='requester_detail'),
